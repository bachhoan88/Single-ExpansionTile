...
class AppExpansionTileState extends State<CustomExpansionTile> with SingleTickerProviderStateMixin {
          ...
          IconTheme.merge(
            ...
            child: ListTile(
              ...
              title: DefaultTextStyle(
                style: Theme.of(context).textTheme.bodyText2!.copyWith(color: titleColor),
                child: widget.title,
              ),
